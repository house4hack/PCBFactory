...
The intent is to fix the gantry and allow each tool to move independently in the Z direction.

to facilitate multiple tools, The tools themselves will be moved into the work position laterally on the gantry.
